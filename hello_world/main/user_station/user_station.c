...
uint8_t wifi_init_sta()
{
    ...
    wifi_stro * wifi_stro2 = nvs_read_data_from_flash();
  //  wifi_config_t wifi_config ;
    ...
    memcpy(wifi_config.sta.ssid,wifi_stro2->save_wifi_ssid,sizeof(wifi_stro2->save_wifi_ssid));
    memcpy(wifi_config.sta.password,wifi_stro2->save_wifi_passward,sizeof(wifi_stro2->save_wifi_passward));
